 ...
 * expects to get two command-line arguments: an int value that determines how
 * many families to simulate, and an int value that serves as the seed of the
 * random numbers generated by the program. Example usage: % java OneOfEachStats
 * 1000 1
 */
